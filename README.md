...
3. 从 [v0.2.0-alpha.6 发布页](https://github.com/moyi888/codex-remote-android/releases/tag/v0.2.0-alpha.6)下载并打开 Windows App，同时安装 Android APK
...
在 [v0.2.0-alpha.6 发布页](https://github.com/moyi888/codex-remote-android/releases/tag/v0.2.0-alpha.6)下载：
...
Android App 内置“诊断日志”。扫码失败后点击“诊断日志”，可复制或分享日志内容。日志会自动隐藏配对 token、设备凭据和 Authorization，不包含任务提示词或对话正文。
...
直接运行 `codex-remote-cli-windows-v0.2.0-alpha.6.exe version` 可查看版本（文件名中的版本号以实际下载为准）。高级模式中的监听地址仍应仅对 Tailnet 开放。
