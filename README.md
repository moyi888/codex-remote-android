...
3. 从 [v0.2.0-alpha.3 发布页](https://github.com/moyi888/codex-remote-android/releases/tag/v0.2.0-alpha.3)下载并打开 Windows App，同时安装 Android APK
...
在 [v0.2.0-alpha.3 发布页](https://github.com/moyi888/codex-remote-android/releases/tag/v0.2.0-alpha.3)下载：
...
直接运行 `codex-remote-cli-windows-v0.2.0-alpha.3.exe version` 可查看版本（文件名中的版本号以实际下载为准）。高级模式中的监听地址仍应仅对 Tailnet 开放。
