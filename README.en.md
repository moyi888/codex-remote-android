...
3. Open the [v0.2.0-alpha.2 release](https://github.com/moyi888/codex-remote-android/releases/tag/v0.2.0-alpha.2), download and launch the Windows App, and install the Android APK
...
Download from the [v0.2.0-alpha.2 release](https://github.com/moyi888/codex-remote-android/releases/tag/v0.2.0-alpha.2):
...
Run `codex-remote-cli-windows-v0.2.0-alpha.2.exe version` to print the version. Adjust the version in the filename to match the downloaded release. Even in advanced mode, expose the listening address only to your Tailnet.
